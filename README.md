<p>
  <img src="src/main/resources/img/icon64.png" alt="Activity Tracker Icon" width="64" style="vertical-align: middle; margin-right: 10px;"/>
  <strong style="font-size: 2em; vertical-align: middle;">Activity Tracker</strong>
</p>
